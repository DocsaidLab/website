...
世界は広いですが、LLM を継続的に改良できる企業は数えるほどしかありません。

研究者たちは、こうした巨大なモデルを使ってさまざまな問題を解きたいと強く望んでいます。だからこそ、それらをどう効率よく微調整するかが重要な課題になります。
...
これまでの研究では、主流の解決策は Adapter でした。以前に次の論文も取り上げています：
