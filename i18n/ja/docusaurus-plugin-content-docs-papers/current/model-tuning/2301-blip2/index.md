...
初代 BLIP がマルチモーダル全般を扱うアーキテクチャだったのに対し、BLIP-2 は少ないパラメータで既存の大規模事前学習モデルを望む方向へ導くことに焦点を当てています。
...
現在の事前学習アーキテクチャは大規模学習を前提としており、膨大な計算資源が必要です。そのうえ、さまざまな下流タスクへそのままうまく適応できるとは限りません。
