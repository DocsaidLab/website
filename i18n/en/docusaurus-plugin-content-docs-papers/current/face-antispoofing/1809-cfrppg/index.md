...
> **True facial micro-motions are just one of the factors; more often, noise is the dominant theme.**
...
These methods are like using a magnifying glass to focus on the peaks, but the magnified target may no longer be the pulse.
