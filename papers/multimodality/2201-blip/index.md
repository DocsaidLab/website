...
最終，作者將過濾後的影像-文本配對與人工標注的配對結合，形成新的資料集來預訓練模型。
...
作者使用兩個人工標注的資料集（COCO 和 Visual Genome）以及三個網路資料集（Conceptual Captions、Conceptual 12M、SBU captions），總共包含 1400 萬張影像，來訓練模型。
