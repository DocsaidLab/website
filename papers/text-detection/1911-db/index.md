...
根據上表，使用可微分二值化技術顯著提升了兩個數據集（MSRA-TD500 和 CTW1500）上的性能。對於 ResNet-18 骨幹網絡，DB 在 MSRA-TD500 數據集上提升了 3.7%，在 CTW1500 數據集上提升了 4.9%的 F 值。

可變形卷積能帶來 1.5%到 5.0%的性能提升，因為它為骨幹網絡提供了靈活的感受野，且只需少量額外時間。在 CTW1500 數據集上，使用 ResNet-18 的性能提升了 3.6%，使用 ResNet-50 的性能提升了 4.9%。
...
在骨幹網絡的比較中，使用 ResNet-50 的檢測器性能優於 ResNet-18，但運行速度較慢。
