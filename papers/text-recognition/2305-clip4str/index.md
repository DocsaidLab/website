...
這代表完成訓練後，我們可以直接以自然語言進行圖片搜索，或是反過來，給圖片讓模型產生對應的敘述。如果在這訓練的過程中，存在像是 STR 任務中的文字圖像，那文字的樣子在 CLIP 的架構中，就會和文字的意義有所關離。
...
2. **LST**：在凍結的 CLIP 上使用一個梯式側向網絡，將特徵先降採樣，再上採樣以配合原特徵維度。
...
- [**[21.01] Prefix-Tuning: 是他？不是他？**](../../llm-tuning/2101-prefix-tuning/index.md)
  :::
