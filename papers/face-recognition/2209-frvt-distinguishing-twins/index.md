...
其中 aigen-002 的性能特別值得關注，其同卵雙胞胎的錯誤配對率為 0.475，意味著該演算法在約一半的案例中沒有將同卵雙胞胎錯誤地識別為同一人。這個 FMR 值雖然遠高於理想標準值（FMR = 0.0001），但仍顯著低於其他多數演算法的 0.98 和 0.99 的 FMR 值，表明該演算法在區分同卵雙胞胎方面具有較好的性能。
