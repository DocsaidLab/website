"use strict";(self.webpackChunkdocsaid_website=self.webpackChunkdocsaid_website||[]).push([["86534"],{57684:function(e,t,i){function a(e,t){e.accDescr&&t.setAccDescription?.(e.accDescr),e.accTitle&&t.setAccTitle?.(e.accTitle),e.title&&t.setDiagramTitle?.(e.title)}i.d(t,{A:()=>a}),(0,i(85587).eW)(a,"populateCommonDb")},18504:function(e,t,i){i.d(t,{diagram:()=>W});var a=i(57684),l=i(42901),r=i(51559),s=i(85587),n=i(17763),c=i(97142),o=s.vZ.pie,p={sections:new Map,showData:!1,config:o},d=p.sections,u=p.showData,g=structuredClone(o),f=(0,s.eW)(()=>structuredClone(g),"getConfig"),h=(0,s.eW)(()=>{d=new Map,u=p.showData,(0,s.ZH)()},"clear"),x=(0,s.eW)(({label:e,value:t})=>{d.has(e)||(d.set(e,t),s.cM.debug(`added new section: ${e}, with value: ${t}`))},"addSection"),m=(0,s.eW)(()=>d,"getSections"),w=(0,s.eW)(e=>{u=e},"setShowData"),S=(0,s.eW)(()=>u,"getShowData"),T={getConfig:f,clear:h,setDiagramTitle:s.g2,getDiagramTitle:s.Kr,setAccTitle:s.GN,getAccTitle:s.eu,setAccDescription:s.U$,getAccDescription:s.Mx,addSection:x,getSections:m,setShowData:w,getShowData:S},$=(0,s.eW)((e,t)=>{(0,a.A)(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},"populateDb"),y={parse:(0,s.eW)(async e=>{let t=await (0,n.Qc)("pie",e);s.cM.debug(t),$(t,T)},"parse")},D=(0,s.eW)(e=>`
  .pieCircle{
