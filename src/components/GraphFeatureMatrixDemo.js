...
const GraphFeatureMatrixDemo = () => {
  ...
  useEffect(() => {
    ...
    const simulation = d3
      ...
      .force("collision", d3.forceCollide().radius((d) => d.age / 2 + 20)); // 根據年齡設定碰撞半徑
    ...
    // 繪製節點圓形，根據年齡和運動習慣設置大小與顏色
    node
      .append("circle")
      .attr("r", (d) => d.age ) // 節點大小由年齡決定
      .attr("fill", (d) => (d.exercise ? "#69b3a2" : "#cccccc")) // 綠色表示有運動習慣，灰色表示沒有
      .attr("stroke", "#333")
      .attr("stroke-width", 2);
